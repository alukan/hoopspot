...
<section class="py-24 px-6">
    <div class="max-w-2xl mx-auto text-center">
        ...
        {{-- City picker --}}
        <form method="GET" class="bg-gray-900 border border-white/10 rounded-2xl p-6 max-w-md mx-auto shadow-xl">
            ...
            <div class="flex gap-3">
                <button
                    type="submit"
                    formaction="{{ route('courts.index') }}"
                    class="flex-1 bg-gray-800 hover:bg-gray-700 border border-white/10 text-white font-semibold rounded-xl px-6 py-3 text-sm transition-colors cursor-pointer"
                >
                    See Courts
                </button>
                <button
                    type="submit"
                    formaction="{{ route('games.index') }}"
                    class="flex-1 bg-orange-500 hover:bg-orange-400 text-white font-semibold rounded-xl px-6 py-3 text-sm transition-colors cursor-pointer"
                >
                    See Games
                </button>
            </div>
